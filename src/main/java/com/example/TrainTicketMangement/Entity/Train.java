...
public class Train {
    ...
    public Train(Long id, String trainName, String trainNumber, String source, String destination, Long totalSeats, LocalTime departureTime, LocalTime arrivingTime, List<TrainSchedule> schedules) {
        this.id = id;
